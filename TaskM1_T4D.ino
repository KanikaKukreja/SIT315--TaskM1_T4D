...
//2110994766
//Task M1_T4D
//Here I used two motion sensors and 1 temperature sensor
//Corresponding toggling led to one motion sensor and buzzer to the
//other and another buzzer for the temperature sensor
